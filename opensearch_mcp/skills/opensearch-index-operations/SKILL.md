...
| `ENABLE_DELEGATION` / `OIDC_CONFIG_URL` / `OIDC_CLIENT_ID` / `OIDC_CLIENT_SECRET` | ✅ | Shared agent-utilities MCP OIDC-delegation surface — required for ANY tool in this package to authenticate. |
